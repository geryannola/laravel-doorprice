...
Route::get('/daftar', [ParticipantController::class, 'daftar'])->name('participant.daftar');
Route::get('/sudahdaftar', [ParticipantController::class, 'sudahdaftar'])->name('participant.sudahdaftar');
Route::post('/daftar', [ParticipantController::class, 'daftarProccess']);
